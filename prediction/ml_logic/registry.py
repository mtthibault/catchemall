...
def save_results(params: dict, metrics: dict) -> None:
    ...
    print("✅ registry.save_results... Results saved locally")


def save_model(model=None):
    # print("✅ registry.save_model... Results saved locally")
...
def load_model(stage="Production"):
    ...
    # else:
    #     return None
    print("✅ registry.load_model... Model loaded from MLflow")
...
def mlflow_transition_model(current_stage: str, new_stage: str) -> None:
    ...
    print(f"✅ registry.mlflow_transition_model")
