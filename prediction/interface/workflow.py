...
from prediction.interface.main import evaluate, preprocess, train
from prediction.ml_logic.registry import mlflow_transition_model
...
def train_flow():
    """
    Build the Prefect workflow for the `catchemall` package. It should:
